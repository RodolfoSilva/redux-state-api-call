(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("redux-state-api-call", [], factory);
	else if(typeof exports === 'object')
		exports["redux-state-api-call"] = factory();
	else
		root["redux-state-api-call"] = factory();
...
var REQUEST_PATTERN = exports.REQUEST_PATTERN = /(.*)_REQUEST$/;
var FAILURE_PATTERN = exports.FAILURE_PATTERN = /(.*)_FAILURE$/;
var SUCCESS_PATTERN = exports.SUCCESS_PATTERN = /(.*)_SUCCESS$/;
var VALID_TYPE_PATTERN = exports.VALID_TYPE_PATTERN = /(.*)_(REQUEST|FAILURE|SUCCESS)$/;
...
var _moduleName = __webpack_require__(1);
...
var validateActionName = function validateActionName(action) {
  return (0, _invariant2.default)(_constants.VALID_TYPE_PATTERN.test(action.toString()), 'The action name "%s" must end with one of those patterns: [_REQUEST, _FAILURE, _SUCCESS]', action);
};
...
var _createLoadingSelector = __webpack_require__(7);
...
var _createErrorMessageSelector = __webpack_require__(9);
...
var _apiStateSelector = __webpack_require__(3);

var _apiStateSelector2 = _interopRequireDefault(_apiStateSelector);

var _constants = __webpack_require__(0);

var _validateActionName = __webpack_require__(4);

var _validateActionName2 = _interopRequireDefault(_validateActionName);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var rootStateSelector = (0, _reselect.createSelector)([_apiStateSelector2.default], function (state) {
  return state.loading;
});

var selectLoading = function selectLoading(state) {
  return function (action) {
    var propertyKey = action.toString().replace(_constants.VALID_TYPE_PATTERN, '$1');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_symbol_observable__ = __webpack_require__(12);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(15);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(13), __webpack_require__(14)(module)))
...
exports.default = function () {
  ...
  var requestName = type.toString().replace(_constants.VALID_TYPE_PATTERN, '$1');

  // Store errorMessage
  // e.g. stores errorMessage when receiving GET_TODOS_FAILURE
  //      else clear errorMessage when receiving GET_TODOS_REQUEST
  return _extends({}, state, _defineProperty({}, requestName, error === true && _constants.FAILURE_PATTERN.test(type) ? payload : null));
};
...
exports.default = function () {
  ...
  return _extends({}, state, _defineProperty({}, requestName, _constants.REQUEST_PATTERN.test(type)));
};
...
//# sourceMappingURL=redux-state-api-call.js.map