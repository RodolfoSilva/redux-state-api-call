...
exports.default = function () {
  ...
  if (!_constants.ASYNC_TYPE_PATTERN.test(action.type)) {
    return state;
  }

  var _splitNameAndTypeFrom = (0, _splitNameAndTypeFromString2.default)(action.type),
  ...
  return _extends({}, state, _defineProperty({}, requestName, errorReducer(state[requestName], _extends({}, action, {
    type: actionType
  }))));
};