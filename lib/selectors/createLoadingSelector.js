...
var rootStateSelector = (0, _reselect.createSelector)([_rootState2.default], function (state) {
  return state.loading;
});

var selectLoading = function selectLoading(state) {
  return function (action) {
    var _splitNameAndTypeFrom = (0, _splitNameAndTypeFromString2.default)(action.toString()),
